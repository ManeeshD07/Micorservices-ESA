var carts = require('../database/usercart.json');
var request = require('request');
const FileSystem = require('fs');
const url = "http://localhost:3000/rest/v1";
        ...
        request(url + "/products", function(error, response, body) {
            ...
            else
            {
                ...
                if(cartitemindex == carts.usercarts[userindex].cart.length) //cart item not found
                {
                    ...
                    FileSystem.writeFile('/home/maneesh/Documents/4-1/ESA/assignments/microservices/database/usercart.json', JSON.stringify(carts), (err) => {
                        if(err) throw err;
                    });//figure out relative fs path

                    FileSystem.writeFile('/home/maneesh/Documents/4-1/ESA/assignments/microservices/database/products.json', JSON.stringify(products), (err) => {
                        if(err) throw err;
                    });
